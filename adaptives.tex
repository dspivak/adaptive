...
Organisms don't defy the physics in which they are implemented. But physics should refer to more than simply the fundamental building blocks of reality; its laws may themselves be organized. Indeed, the original concept of physics referred to the totality of how nature is put together---constructed---and not just to any sort of atomic bedrock at a purportedly bottom layer. The concept of \emph{emergence} is often used to rescue a bottom-up interpretation of physics from the experimental data showing that higher-level structures have downward causality on the patterns that arise in lower-level parts \cite{laughlin2005different}.
